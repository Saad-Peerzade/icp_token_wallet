...
import { idlFactory } from './my_token_wallet_backend.did.js';
export { idlFactory } from './my_token_wallet_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.MY_TOKEN_WALLET_BACKEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./my_token_wallet_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the my_token_wallet_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./my_token_wallet_backend.did.js")._SERVICE>}
 */
export const my_token_wallet_backend = createActor(canisterId);
